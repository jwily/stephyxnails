              ...
              <div className="p-8 shadow-lg">
                <form className="space-y-4">
                  <div className="w-full">
                    ...
                    <input className="input input-solid max-w-full bg-white text-black" placeholder="" type="number" id="number" value={extra} onChange={handleInputChange} />
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input className="input input-solid bg-white text-black" placeholder="" type="number" id="number" value={extra2} onChange={handleInputChange2} />
