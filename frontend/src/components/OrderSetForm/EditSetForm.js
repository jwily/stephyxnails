            ...
            <div>
              <div className="accordion-group">
                <div className="accordion">
                  ...
                  <label htmlFor="accordion-2" className="accordion-title bg-red-100">Tier</label>
                  ...
                  <div className="accordion">
                    ...
                    <label htmlFor="accordion-1" className="accordion-title bg-red-100">Shape</label>
                    <div className="accordion-content">
                      <div className="min-h-0">
                        <label>Shape:</label>
                  ...
                  <div className="accordion">
                    ...
                    <label htmlFor="accordion-3" className="accordion-title bg-red-100">LeftDisplay</label>
                    <div className="accordion-content">
                      <div className="min-h-0">
                  ...
                  <div className="accordion">
                    ...
                    <label htmlFor="accordion-4" className="accordion-title bg-red-100">Right Display</label>
                    <div className="accordion-content">
                      <div className="min-h-0">
                  ...
                  <div className="accordion">
                    ...
                    <label htmlFor="accordion-5" className="accordion-title bg-red-100">Photo</label>
                    <div className="accordion-content">
                      <div className="min-h-0">
                        <label>Photo:</label>
                        <input
                  ...
                  <div className="accordion">
                    ...
                    <label htmlFor="accordion-6" className="accordion-title bg-red-100">Description</label>
                    <div className="accordion-content">
                      <div className="min-h-0">
                  ...
                  <div className="accordion">
                    ...
                    <label htmlFor="accordion-7" className="accordion-title bg-red-100">Charm</label>
                    <div className="accordion-content">
                      <div className="min-h-0">
                        <label>charm:</label>
                        <input
                  ...
                  <div className="accordion">
                    ...
                    <label htmlFor="accordion-8" className="accordion-title bg-red-100">Character</label>
                    <div className="accordion-content">
                      <div className="min-h-0">
